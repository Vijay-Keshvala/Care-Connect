...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[800vh] overflow-y-scroll'>
                ...
                <div>
                    ...
                    <textarea onChange={(e) => setAbout(e.target.value)} value={about}  
                        className='w-full px-4 pt-2 border rounded' placeholder='About doctor' rows={5} required />
                </div>
                <button type='submit' className='bg-primary cursor-pointer px-10 py-3 mt-4 text-white rounded-full'>Add Doctor</button>
            </div>
        </form>
    );
};
